...
reviewMiddleware.Review = {
    fetchProductReview: async ({ body }) => {
        if (body.productId != null && body.productId != undefined && Object.keys(body.productId).length != 0) {
    ...
    createReview: async ({ body, token }) => {
        ...
        if (fetchUser != null && fetchUser != undefined && Object.keys(fetchUser).length != 0) {
            ...
            body.customerImage = fetchUser?.profilePic || configs.placeholder || "/images/placeholder.jpg";
