...
CartController.Cart = {
    ...
    * @param {*} body 
    */
    addCustomCart: async (req, res) => {

        cartMiddleware.Cart.createCustomCart(req)
            .then((data) => {
                const response = ApplicationResult.forCreated();
                var statuscode = 0;
                ApplicationResponse.success(
    ...
    getAllMeasurements: async (req, res) => {
        ...
        cartMiddleware.Cart.getAllMeasurements(req)
            .then((data) => {
                const response = ApplicationResult.forCreated();
                var statuscode = 0;
                ApplicationResponse.success(
    ...
    /**
        ...
        * @param {*} body 
        */
    getOneMeasurements: async (req, res) => {

        cartMiddleware.Cart.getOneMeasurements(req)
            .then((data) => {
                const response = ApplicationResult.forCreated();
                var statuscode = 0;
                ApplicationResponse.success(
    ...
    /**
        * @name update all size
        * @param {*} body 
        */
    updateMeasurements: async (req, res) => {

        cartMiddleware.Cart.updateMeasurements(req)
            .then((data) => {
                const response = ApplicationResult.forCreated();
                var statuscode = 0;
                ApplicationResponse.success(
    ...
    /**
            ...
            * @param {*} body 
            */
    deleteMeasurements: async (req, res) => {

        cartMiddleware.Cart.deleteMeasurements(req)
            .then((data) => {
                const response = ApplicationResult.forCreated();
                var statuscode = 0;
                ApplicationResponse.success(
